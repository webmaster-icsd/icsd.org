...
<div class="row pt-10 pb-3">
  ...
  <div class="col-md-12 col-12 pb-3">
          <a class="btn btn-sm btn-danger" href="https://goodbricksapp.com/icsd.org/cause/ramadan-2021-iftar" style="width: 100%;padding:12px;white-space: normal;">Ramadan 2021 Iftar</a>
    </div>
  
  <div class="col-md-6 col-6 pb-3">
          <a class="btn btn-sm btn-success" href="https://goodbricksapp.com/icsd.org/cause/expansion" style="width: 100%;padding:12px;white-space: normal;">ICSD Expansion (Neighboring property purchase)</a>
    </div>
    <div class="col-md-6 col-6 pb-3">
      <a class="btn btn-sm btn-success" href="https://goodbricksapp.com/icsd.org/cause/masjid-operation" style="width: 100%;padding:12px;">Main Masjid Operations</a>
  </div>
...
<div class="row pt-10 pb-2" >
  ...
  <div class="col-md-6 col-6 pb-3">
        <a class="btn btn-sm btn-success" href="https://goodbricksapp.com/icsd.org/cause/east-county-masjid" style="width: 100%;padding:12px;">East County Masjid</a>
    </div>
